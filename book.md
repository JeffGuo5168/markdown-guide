...
<div class="row" style="padding-bottom: 30px">
  <div class="col-sm-5" style="margin-top: 5px"><img src="/markdown-guide/assets/images/book-cover.jpg" style="width: 95%" alt="The Markdown Guide book cover"></div>
  <div class="col-sm-7">
    ...
    <div class="row" style="margin-top:15px; margin-bottom:25px">
      <div class="col-sm-12">
        <a class="btn btn-success btn-lg" style="margin-right: 20px; margin-top: 5px" href="/markdown-guide/assets/book/markdown-guide.pdf">Get the PDF File</a>

        <a class="btn btn-success btn-lg" style="margin-right: 20px; margin-top: 5px" href="/markdown-guide/assets/book/markdown-guide.epub">Get the EPUB File</a>

        <a class="btn btn-success btn-lg" style="margin-top: 5px" href="/markdown-guide/assets/book/markdown-guide.mobi">Get the MOBI File</a>
      </div>
    </div>
